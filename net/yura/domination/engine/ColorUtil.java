...
/**
 * instead of using java.awt.Color works on Desktop java and Android
 * 
 * @author Yura Mamyrin
 */
public class ColorUtil {
	...
	public static final int BLACK = 0xFF000000, WHITE = 0xFFFFFFFF,
			LIGHT_GRAY = 0xFFC0C0C0, GRAY = 0xFF808080, DARK_GRAY = 0xFF404040,
			RED = 0xFFFF0000, PINK = 0xFFFFAFAF, ORANGE = 0xFFFFC800,
			YELLOW = 0xFFFFFF00, GREEN = 0xFF00FF00, MAGENTA = 0xFFFF00FF,
			CYAN = 0xFF00FFFF, BLUE = 0xFF0000FF;
	...
	/**
	 * get a color as a int from a string, alpha is set to 255 if we can not get
	 * the color then we return 0
	 */
	...
	public static int getTextColorFor(int c) {
		 ...
		 * 
		 * if (r > 240 || g > 240) { return Color.black; } else { return
		 * Color.white; }
		 */
	...
	public static String getHexForColor(int c) {
		return "#"
				+ Integer.toHexString((c & 0xffffff) | 0x1000000).substring(1);
	}
