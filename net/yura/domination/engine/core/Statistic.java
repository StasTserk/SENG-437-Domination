...
public class Statistic implements Serializable {
	...
	private double dice;
	private int diceCount; // Computing the average of dices requires knowing
							// their count.
	...
	public void endGoStatistics(int countries, int armies, int continents,
			int conectedEmpire, int cards) {
	 ...
	 * 
	 * @param diceValue
	 *            the internal value of a dice (from 0 to 5)
	 */
