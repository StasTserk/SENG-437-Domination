...
public class Player implements Serializable {
	 ...
	 * 
	 * @param t
	 *            The type of the player (human or AI)
	 * @param n
	 *            The name of the player
	 * @param c
	 *            The color of the player
	 * @param a
	 *            THe address of the player on the current computer
	 */
	 ...
	 * 
	 * @param n
	 *            The number of armies you want to add
	 */
	 ...
	 * 
	 * @param n
	 *            The number of armies you want to minus
	 */
	...
	/**
	 * Trading in the cards, adds 2 extra armies to the first country that it
	 * owns on the cards and removing the cards from the player
	 * 
	 * @param card1
	 *            First card
	 * @param card2
	 ...
	 * 
	 * @param lessCountry
	 *            The country you want to remove
	 */
	 ...
	 * 
	 * @param a
	 *            String The address of the computer
	 */
