...
public class Country implements Serializable {
	...
	private transient List<Country> incomingNeighbours = new ArrayList<Country>(
			2);
	 ...
	 * @param t
	 *            the name of the country
	 * @return returns true if the two countries are adjacent, false if the two
	 *         countries are no adjacent
	 */
	...
	/**
	 * Returns the colour (unique) of the country starting from 1, NOT FROM ZERO
	 * 
	 * @return color
	 */
	public int getColor() {
