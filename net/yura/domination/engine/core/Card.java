...
public class Card implements Serializable {
	 ...
	 * 
	 * @param n
	 *            describes the type of the card, e.g. calvary, cannon, infantry
	 *            or wildcard
	 * @param t
	...
	public void setName(String n) {
		...
		if (!n.equals(CAVALRY) && !n.equals(INFANTRY) && !n.equals(CANNON)
				&& !n.equals(WILDCARD)) {

			throw new IllegalArgumentException(
					"trying to make a card with an unknown type: " + n);
