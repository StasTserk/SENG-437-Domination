...
public class Continent implements Serializable {
	 ...
	 *            the continent name
	 * @param c
	 *            the continent colour
	 * @param noa
	 *            the number of armies recieved when the whole continent is
	 *            owned
	 */
	 ...
	 *         otherwise false if the player does not own the all the
	 *         territories
	 */
	...
	/*****
	 * @name getOwner
	 * @return player who owns the continent else null if no one owns the
	 *         continent
	 ****/
	...
	public boolean equals(Object o) {
		...
		return (o != null && o instanceof Continent
				&& ((Continent) o).name.equals(name)
				&& ((Continent) o).idString.equals(idString) && ((Continent) o).armyValue == armyValue);
