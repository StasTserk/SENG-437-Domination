...
public class Mission implements Serializable {
	 ...
	 * 
	 * @param p
	 *            The player who must be killed
	 * @param noc
	 *            The number of countries needed to own
	 * @param noa
	 *            The minimum number of armies needed on a territory
	 * @param c1
	 *            The first continent needed to own
	 * @param c2
	 *            The second continent needed to own
	 * @param c3
	 *            The third continent needed to own
	 * @param d
	 *            The description of the mission
	 */
	public Mission(Player p, int noc, int noa, Continent c1, Continent c2,
			Continent c3, String d) {
